...
class Indi_Ai {
     ...
     * @var string
     */
    public $resp = 'data/prompt/scratch.txt';
     ...
     * @var string
     */
    public $code = 'data/prompt/scratch.php';

    /**
     * File where AI model response should be picked from instead of making real request to AI
     *
     * @var string
     */
    ...
    public function prepare() {
        ...
        $resp = file_get_contents($this->debug ?: $this->resp);

        // Parse php function calls and put unparsed into trash.txt
        file_put_contents("data/prompt/trash.txt", $this->parseCalls($resp));
