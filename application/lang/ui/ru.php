...
alteredField('sectionActions', 'roleIds', ['rename' => '']);
alteredField('sectionActions', 'roleIds', ['title' => 'Роли']);
...
enumset('filter', 'toggle', 'n', ['title' => '<span class="i-color-box" style="background: red;"></span>Выключен']);
enumset('filter', 'toggle', 'y', ['title' => '<span class="i-color-box" style="background: lime;"></span>Включен']);
enumset('grid', 'accessRoles', 'all', ['title' => 'Все']);
enumset('grid', 'accessRoles', 'none', ['title' => 'Никто']);
enumset('grid', 'colorBreak', 'n', ['title' => '<span class="i-color-box" style="background: white;"></span>Выключена']);
enumset('grid', 'colorBreak', 'y', ['title' => '<span class="i-color-box" style="background: url(resources/images/icons/color-level.png);"></span>Включена']);
...
enumset('grid', 'editor', 'enumNoCycle', ['title' => '<span class="i-color-box" style="background: orange;"></span>Выключен, в том числе смена значения из набора по клику']);
...
enumset('section', 'filterOwner', 'certain', ['title' => '<span class="i-color-box" style="background: url(resources/images/icons/filter-key-blue.png);"></span>Да, для некоторых действий']);
enumset('section', 'filterOwner', 'no', ['title' => '<span class="i-color-box" style="background: white;"></span>Нет']);
enumset('section', 'filterOwner', 'yes', ['title' => '<span class="i-color-box" style="background: url(resources/images/icons/filter-key-red.png);"></span>Да, для всех действий']);
...
enumset('section2action', 'filterOwner', 'certain', ['title' => '<span class="i-color-box" style="background: url(resources/images/icons/filter-key-blue.png);"></span>Да, для некоторых ролей']);
enumset('section2action', 'filterOwner', 'no', ['title' => '<span class="i-color-box" style="background: white;"></span>Нет']);
enumset('section2action', 'filterOwner', 'yes', ['title' => '<span class="i-color-box" style="background: url(resources/images/icons/filter-key-red.png);"></span>Да, для всех ролей']);
enumset('section2action', 'fitWindow', 'n', ['title' => '<span class="i-color-box" style="background: white;"></span>Выключено']);
enumset('section2action', 'fitWindow', 'y', ['title' => '<span class="i-color-box" style="background: url(resources/images/icons/fit.png);"></span>Включено']);
...
enumset('section2action', 'south', 'auto', ['title' => '<span class="i-color-box" style="background: url(resources/images/icons/south-blue.png);"></span>Авто']);
enumset('section2action', 'south', 'no', ['title' => '<span class="i-color-box" style="background: url(resources/images/icons/south-red.png);"></span>Не отображать']);
enumset('section2action', 'south', 'yes', ['title' => '<span class="i-color-box" style="background: url(resources/images/icons/south-green.png);"></span>Отображать']);
...
filter('actions', 'fraction', ['title' => 'Тип']);
