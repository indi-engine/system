...
enumset('filter', 'allowZeroResult', 'exceptPrefiltered', ['title' => 'Да, кроме случаев когда используются некоторые фильтры']);
...
field('filter', 'allowZeroResultExceptPrefilteredWith', ['title' => 'кроме случаев, когда используются фильтры для полей']);
...
field('noticeGetter', 'wsmsg', ['title' => 'Сообщение спереди / WebSocket']);
...
grid('filter', 'allowZeroResult', ['tooltip' => 'Показывать все опции, в том числе<br>с пустыми результатами поиска']);
grid('filter', 'allowZeroResultExceptPrefilteredWith', ['rename' => '']);
grid('filter', 'allowZeroResultExceptPrefilteredWith', ['summaryText' => '']);
grid('filter', 'allowZeroResultExceptPrefilteredWith', ['title' => 'кроме случаев, когда используются фильтры для полей']);
