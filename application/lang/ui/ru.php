...
enumset('filter', 'access', 'all', ['title' => 'Всем']);
enumset('filter', 'access', 'except', ['title' => 'Всем, кроме']);
enumset('filter', 'access', 'only', ['title' => 'Никому, кроме']);
...
field('filter', 'accesss', ['title' => 'Доступ']);
...
field('filter', 'roleIds', ['title' => 'Кроме']);
...
grid('alteredFields', 'impact', ['rename' => 'Роли']);
...
grid('roles', 'maxWindows', ['rename' => 'МКО']);
...
grid('filter', 'roleIds', ['title' => 'Выбранные']);
...
section2action('filter','export', ['rename' => '']);
