...
enumset('alteredField', 'accessRoles', 'all', ['title' => 'Все роли']);
...
enumset('filter', 'accessRoles', 'all', ['title' => 'Все роли']);
...
enumset('grid', 'accessRoles', 'all', ['title' => 'Все роли']);
...
field('grid', 'source', ['title' => 'Источник']);
...
grid('filter', 'accessExcept', ['title' => 'Выбранные']);
...
grid('grid', 'accessRoles', ['rename' => 'Кому']);
...
grid('grid', 'source', ['title' => 'Источник']);
...
grid('sections', 'data', ['rename' => 'Источник']);
