...
enumset('grid', 'toggleTile', 'y', ['title' => 'Turned on']);
...
field('grid', 'panels', ['title' => 'Toggle in panels']);
...
grid('grid', 'panels', ['rename' => 'Toggle']);
grid('grid', 'panels', ['summaryText' => '']);
grid('grid', 'panels', ['title' => 'Toggle in panels']);
grid('grid', 'panels', ['tooltip' => 'Toggle in panels']);
