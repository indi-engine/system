...
enumset('grid', 'toggleTile', 'boxes', ['title' => 'Box under image']);
enumset('grid', 'toggleTile', 'n', ['title' => 'Turned off']);
enumset('grid', 'toggleTile', 'right', ['title' => 'Box at the right']);
...
field('action', 'hasView', ['title' => 'Has view']);
...
grid('actions', 'hasView', ['title' => 'Has view']);
