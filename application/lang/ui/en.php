...
alteredField('entities', 'monthFieldId', ['title' => 'Field to setup and derive \'Month\' field from']);
...
alteredField('entities', 'titleFieldId', ['title' => 'Field to use as or derive \'Title\' field from']);
...
cfgField('element', 'number', 'shade', ['title' => 'Shade']);
...
cfgField('element', 'price', 'shade', ['title' => 'Shading']);
...
cfgField('element', 'upload', 'wide', ['title' => 'Full width']);
...
consider('filter', 'allowZeroResultExceptPrefilteredWith', 'sectionId', ['title' => 'Section']);
...
consider('grid', 'formNotShowGridIds', 'sectionId', ['title' => 'Section']);
...
enumset('alteredField', 'jumpCreate', 'n', ['title' => 'Disabled']);
enumset('alteredField', 'jumpCreate', 'y', ['title' => 'Enabled']);
...
enumset('alteredField', 'toggle', 'creating', ['title' => 'Turned on, but for creating records only']);
enumset('alteredField', 'toggle', 'existing', ['title' => 'Turned on, but for existing records only']);
enumset('alteredField', 'toggle', 'n', ['title' => 'Turned off']);
enumset('alteredField', 'toggle', 'y', ['title' => 'Turned on']);
...
enumset('noticeGetter', 'wsmsg', 'n', ['title' => 'No']);
enumset('noticeGetter', 'wsmsg', 'y', ['title' => 'Yes']);
...
field('alteredField', 'jumpCreate', ['title' => '\'Create new\' button']);
...
field('changeLog', 'fieldId', ['title' => 'Field']);
...
field('entity', 'monthFieldId', ['title' => 'Field to setup and derive \'Month\' field from']);
...
field('entity', 'special', ['title' => 'Special fields']);
...
field('entity', 'titleFieldId', ['title' => 'Field to use as or derive \'Title\' field from']);
...
field('filter', 'allowZeroResultExceptPrefilteredWith', ['title' => 'If yes, except when filters are in use for fields']);
...
field('grid', 'formNotShowGridIds', ['title' => 'Don\'t show which involved columns']);
...
field('notice', 'tplIncAudio', ['title' => 'Audio']);
...
field('noticeGetter', 'method', ['title' => 'Delivery']);
...
field('noticeGetter', 'wsmsg', ['title' => 'Side message / WebSocket']);
...
field('section', 'noExcel4RoleIds', ['title' => 'Roles to disable Excel-export for']);
...
grid('alteredFields', 'jumpCreate', ['title' => '\'Create new\' button']);
...
grid('entities', 'monthFieldId', ['title' => 'Field to setup and derive \'Month\' field from']);
...
grid('entities', 'special', ['title' => 'Special fields']);
...
grid('entities', 'titleFieldId', 'alias', ['title' => 'Field to use as or derive \'Title\' field from']);
grid('entities', 'titleFieldId', 'alias', ['tooltip' => '']);
grid('entities', 'titleFieldId', ['rename' => '']);
grid('entities', 'titleFieldId', ['summaryText' => '']);
grid('entities', 'titleFieldId', ['title' => 'Field to use as or derive \'Title\' field from']);
...
grid('fieldEnumset', 'alias', ['rename' => '']);
grid('fieldEnumset', 'alias', ['summaryText' => '']);
grid('fieldEnumset', 'alias', ['title' => 'Alias']);
grid('fieldEnumset', 'alias', ['tooltip' => '']);
grid('fieldEnumset', 'boxColor', ['rename' => '']);
grid('fieldEnumset', 'boxColor', ['summaryText' => '']);
grid('fieldEnumset', 'boxColor', ['title' => 'Box color']);
grid('fieldEnumset', 'boxColor', ['tooltip' => '']);
grid('fieldEnumset', 'boxIcon', ['rename' => '']);
grid('fieldEnumset', 'boxIcon', ['summaryText' => '']);
grid('fieldEnumset', 'boxIcon', ['title' => 'Box icon']);
grid('fieldEnumset', 'boxIcon', ['tooltip' => '']);
grid('fieldEnumset', 'cssStyle', ['rename' => '']);
grid('fieldEnumset', 'cssStyle', ['summaryText' => '']);
grid('fieldEnumset', 'cssStyle', ['title' => 'CSS styles']);
grid('fieldEnumset', 'cssStyle', ['tooltip' => '']);
grid('fieldEnumset', 'features', ['rename' => '']);
grid('fieldEnumset', 'features', ['summaryText' => '']);
grid('fieldEnumset', 'features', ['title' => 'Features']);
grid('fieldEnumset', 'features', ['tooltip' => '']);
grid('fieldEnumset', 'move', ['rename' => '']);
grid('fieldEnumset', 'move', ['summaryText' => '']);
grid('fieldEnumset', 'move', ['title' => 'Order']);
grid('fieldEnumset', 'move', ['tooltip' => '']);
grid('fieldEnumset', 'textColor', ['rename' => '']);
grid('fieldEnumset', 'textColor', ['summaryText' => '']);
grid('fieldEnumset', 'textColor', ['title' => 'Text color']);
grid('fieldEnumset', 'textColor', ['tooltip' => '']);
grid('fieldEnumset', 'title', ['rename' => '']);
grid('fieldEnumset', 'title', ['summaryText' => '']);
grid('fieldEnumset', 'title', ['title' => 'Title']);
grid('fieldEnumset', 'title', ['tooltip' => '']);
...
grid('filter', 'allowZeroResultExceptPrefilteredWith', ['title' => 'If yes, except when filters are in use for fields']);
...
grid('grid', 'formNotShowGridIds', ['title' => 'Don\'t show which involved columns']);
...
grid('noticeGetters', 'method', ['rename' => 'Duplicate']);
grid('noticeGetters', 'method', ['summaryText' => '']);
grid('noticeGetters', 'method', ['title' => 'Delivery']);
...
grid('noticeGetters', 'wsmsg', ['title' => 'Side message / WebSocket']);
...
grid('role', 'dashboard', ['rename' => 'Dashboard']);
...
grid('sections', 'noExcel4RoleIds', ['title' => 'Roles to disable Excel-export for']);
...
section('fieldEnumset', ['help' => '']);
section('fieldEnumset', ['title' => 'Enumerated values']);
section('fields', ['help' => '']);
...
section('params', ['help' => '']);
section('params', ['title' => 'Element-specific params']);
...
section2action('actions','dns', ['title' => 'Required DNS-records']);
...
section2action('fieldEnumset','delete', ['rename' => '']);
section2action('fieldEnumset','delete', ['title' => 'Delete']);
section2action('fieldEnumset','down', ['rename' => '']);
section2action('fieldEnumset','down', ['title' => 'Move down']);
section2action('fieldEnumset','export', ['rename' => 'Export as PHP-code']);
section2action('fieldEnumset','export', ['title' => 'Export']);
section2action('fieldEnumset','form', ['rename' => '']);
section2action('fieldEnumset','form', ['title' => 'Details']);
section2action('fieldEnumset','index', ['rename' => '']);
section2action('fieldEnumset','index', ['title' => 'List']);
section2action('fieldEnumset','save', ['rename' => '']);
section2action('fieldEnumset','save', ['title' => 'Save']);
section2action('fieldEnumset','up', ['rename' => '']);
section2action('fieldEnumset','up', ['title' => 'Move up']);
...
section2action('fieldsAll','export', ['rename' => 'Export as PHP-code']);
section2action('fieldsAll','export', ['title' => 'Export']);
