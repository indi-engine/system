...
alteredField('sectionActions', 'roleIds', ['title' => 'Access']);
...
enumset('action', 'fraction', 'public', ['title' => '<font color=lime>Common</font>']);
...
enumset('entity', 'fraction', 'public', ['title' => '<font color=lime>Common</font>']);
...
enumset('grid', 'colorBreak', 'n', ['title' => '<span class="i-color-box" style="background: white;"></span>Turned off']);
...
enumset('section', 'filterOwner', 'certain', ['title' => '<span class="i-color-box" style="background: url(resources/images/icons/filter-key-blue.png);"></span>Yes, for certain actions']);
enumset('section', 'filterOwner', 'no', ['title' => '<span class="i-color-box" style="background: white;"></span>No']);
enumset('section', 'filterOwner', 'yes', ['title' => '<span class="i-color-box" style="background: url(resources/images/icons/filter-key-red.png);"></span>Yes, for all actions']);
enumset('section', 'fraction', 'custom', ['title' => 'Custom']);
enumset('section', 'fraction', 'public', ['title' => '<font color=lime>Common</font>']);
...
enumset('section', 'showID', 'n', ['title' => '<span class="i-color-box" style="background: white;"></span>No']);
enumset('section', 'showID', 'y', ['title' => '<span class="i-color-box" style="background: url(resources/images/icons/id.png);"></span>Yes']);
...
enumset('section2action', 'filterOwner', 'certain', ['title' => '<span class="i-color-box" style="background: url(resources/images/icons/filter-key-blue.png);"></span>Yes, for certain owner roles']);
enumset('section2action', 'filterOwner', 'no', ['title' => '<span class="i-color-box" style="background: white;"></span>No']);
enumset('section2action', 'filterOwner', 'yes', ['title' => '<span class="i-color-box" style="background: url(resources/images/icons/filter-key-red.png);"></span>Yes, for all owner roles']);
enumset('section2action', 'fitWindow', 'n', ['title' => '<span class="i-color-box" style="background: white;"></span>Turned off']);
enumset('section2action', 'fitWindow', 'y', ['title' => '<span class="i-color-box" style="background: url(resources/images/icons/fit.png);"></span>Turned on']);
...
enumset('section2action', 'south', 'auto', ['title' => '<span class="i-color-box" style="background: url(resources/images/icons/south-blue.png);"></span>Auto']);
enumset('section2action', 'south', 'no', ['title' => '<span class="i-color-box" style="background: url(resources/images/icons/south-red.png);"></span>Do not display']);
enumset('section2action', 'south', 'yes', ['title' => '<span class="i-color-box" style="background: url(resources/images/icons/south-green.png);"></span>Display']);
