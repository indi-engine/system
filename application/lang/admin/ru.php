...
define('I_QUEUE_STARTED', 'запущена');
define('I_QUEUE_RESUMED', 'возобновлена');
define('I_QUEUE_COMPLETED', 'завершена');
...
define('I_FIELD_DRAG_CLICK', 'Перетащите для смены порядка / Кликните для редактирования');
define('I_OPEN_DETAILS', 'Кликните для редактирования');
define('I_ALTER_FIELDS', 'Кликните для изменения полей в этом разделе');
define('I_ACTION_FORM', 'Детали');
