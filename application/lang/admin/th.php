...
define('I_WS_CONNECTED', 'เชื่อมต่อแล้วใน %s มิลลิวินาที');
define('I_WS_DISCONNECTED', 'ตัดการเชื่อมต่อแล้ว');
define('I_WS_RECONNECTING', 'กำลังเชื่อมต่อใหม่...');
define('I_WS_RECONNECTED', 'เชื่อมต่ออีกครั้งใน %s ms');
...
define('I_UPLOAD_ERR_EXTENSION', 'การอัปโหลดไฟล์ในช่อง "%s" หยุดโดยส่วนขยาย php อันใดอันหนึ่งซึ่งทำงานบนเซิร์ฟเวอร์');
...
define('I_L10N_TOOGLE_FIELD_DENIED', 'ไม่อนุญาตให้เปิด/ปิดการแปลเป็นภาษาท้องถิ่นสำหรับฟิลด์ที่ต้องพึ่งพา');
...
define('I_QUEUE_STARTED', 'เริ่ม');
define('I_QUEUE_RESUMED', 'ดำเนินการต่อ');
define('I_QUEUE_COMPLETED', 'สมบูรณ์');
...
define('I_MDL_CHLOG_NO_REVERT_2', 'การย้อนกลับถูกเปิดใช้งานสำหรับฟิลด์ประเภท %s และ %s เท่านั้น');
...
define('I_OPEN_DETAILS', 'คลิกเพื่อดูรายละเอียด');
define('I_ALTER_FIELDS', 'คลิกเพื่อปรับเปลี่ยนฟิลด์สำหรับส่วนนี้');
